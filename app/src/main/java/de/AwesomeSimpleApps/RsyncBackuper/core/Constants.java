...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "de.AwesomeSimpleApps.RsyncBackuper";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "Rsync Backuper";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "de.AwesomeSimpleApps.RsyncBackuper.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "de.AwesomeSimpleApps.RsyncBackuper.";
