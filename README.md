...
* Rsync Backuper is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as Rsync Backuper is mean to act as a starting point for Android Applications.

# Rsync Backuper App

[![Build Status](https://travis-ci.org/AndroidBootstrap/de-awesomesimpleapps-rsyncbackuper.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/de-awesomesimpleapps-rsyncbackuper)

This repository contains the source code for the [Rsync Backuper](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=de.AwesomeSimpleApps.RsyncBackuper).

Please see the [issues](https://github.de.AwesomeSimpleApps.RsyncBackuper/de-awesomesimpleapps-rsyncbackuper/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Rsync Backuper? Ask away on the [de-awesomesimpleapps-rsyncbackuper discussion forum](https://groups.google.com/forum/#!forum/de-awesomesimpleapps-rsyncbackuper).

<a href="https://play.google.com/store/apps/details?id=de.AwesomeSimpleApps.RsyncBackuper" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __de.AwesomeSimpleApps.RsyncBackuper__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____de.AwesomeSimpleApps.RsyncBackuper__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.de.AwesomeSimpleApps.RsyncBackuper.R__) will now be renamed
...
signed with a different key.  Manually uninstall Rsync Backuper from your device and
...
Rsync Backuper is a result of a template project I've developed over the years as well as
...
Rsync Backuper is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.de.AwesomeSimpleApps.RsyncBackuper/de-awesomesimpleapps-rsyncbackuper/contributors) on
...
[pull requests](https://github.de.AwesomeSimpleApps.RsyncBackuper/de-awesomesimpleapps-rsyncbackuper/pulls).
