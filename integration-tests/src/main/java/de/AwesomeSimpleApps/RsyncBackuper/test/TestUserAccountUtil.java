...
import static de.AwesomeSimpleApps.RsyncBackuper.core.Constants.Auth.*;

import de.AwesomeSimpleApps.RsyncBackuper.tests.R;
import de.AwesomeSimpleApps.RsyncBackuper.util.Ln;
